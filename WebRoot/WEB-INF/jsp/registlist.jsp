...
<body class="homepage" data-spy="scroll" data-target=".navbar">
  ...
  <main role="main" class="row col-md-6 col-md-offset-3">
  	<div class="input-group">
				...
				<input class="form-control" type="search" id="input-filter" size="15" placeholder="输入关键字"></input>
	</div>
  	...
  	<thead>
  		<tr>
	   	...
	   	<tbody>
	   		<s:iterator var="Regist" value="#request.registList">
	   			<s:if test="Regist.status!=0">
						<tr>
							...
							<td>
								<s:property value="#Regist.r_sympton"/></a>
							</td>
							<td>
								<s:property value="#Regist.r_sex"/></a>
							</td>
							<td>
								<s:property value="#Regist.r_age"/></a>
							</td>
							<td>
								<s:property value="#Regist.r_date"/></a>
							</td>
							<td>
								已处理</a>
							</td>
