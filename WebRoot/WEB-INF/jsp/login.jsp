...
<body class="homepage" data-spy="scroll" data-target=".navbar">
  ...
  <main role="main" >
    ...
    <form class="form-horizontal" role="form" action="${ pageContext.request.contextPath }/user_login.action"  method="post" novalidate="novalidate">
    	<div class="row">
  			<div class="login-title"><h1><strong>登录</strong></h1></div>
  		</div>
  		...
  		<div class="form-group">
  		    <div class="row">
    		<div class="col-sm-offset-2 col-xs-3 col-xs-offset-2">
