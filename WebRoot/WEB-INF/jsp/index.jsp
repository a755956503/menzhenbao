  ...
  <main role="main">
    ...
    <section id="welcome" class="jumbotron">
      <div class="container">
        <div class="welcome-message">
          <h1><strong>门诊宝</strong></h1>
          <p>这是一个免费的挂号平台 <br>专门为门诊及中小型医院和病人服务<br>因为精准，所以专业</p>
        </div><!-- /.welcome-message -->
      </div>
    </section>
    ...
    <section id="features">
      <div class="container">
        <h1>门诊列表</h1>
        <div class="row">
        <s:iterator var="p" value="hospitalList">
        
        	<div class="features-item col-sm-6 col-md-4">
        	<a href="${pageContext.request.contextPath}/regist_into.action?h_name=<s:property value="h_name"/>">
               <img src="${pageContext.request.contextPath}/myimage/hospital0.jpg">
               <h2><s:property value="#p.h_name"/></h2>
               <p>地址：      <s:property value="#p.h_address"/></p>
            </a>
            </div>
		</s:iterator>
